...
def train():
    ...
    model = create_swin(num_classes).to(device)
    ...
    print("\n" + "="*60)
    print("MODEL INFORMATION: Swin Transformer")
    print("="*60)
    ...
    print("Model saved to models/swin_model.pth")
    print("Best model saved to models/swin_model_best.pth")
    
    with open("outputs/results/swin_log.json", "w") as f:
        json.dump({
    ...
    print("Training log saved to outputs/results/swin_log.json")
